...
| [`ui/chat.spec.ts`](../tests/ui/chat.spec.ts) | Mocked chat question submission with the five-part grounded answer, evidence affordance, and explicit prediction limit |
