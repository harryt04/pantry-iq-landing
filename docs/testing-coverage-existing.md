...
| [`src/server/csv/`](../src/server/csv/) | 8 | `mapping` 98.4%, `security` 98.5%, `parser` 95.8%, `import-plan` 94.7%; parser tests cover long problem-example truncation; mapping reuse rejects duplicate incoming columns; import planning rejects negative non-negative labor values |
