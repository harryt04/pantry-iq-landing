...
| Leads with | "$840 at risk" | "12 lbs of prepared soup, ready 9pm tonight" |
...
> ✅ I can't calculate margin for these items — you haven't uploaded unit costs yet. What I can tell you is which items are moving slowest, and that's below.
...
> ❌ I analysed your transaction history and inventory levels to determine the risk.
...
3. **Prediction** *(only if ≥4 weeks of history exists)* — labelled, with basis
...
>
> **PantryIQ:** Fair — 3 days is my default for fresh fish, not something
...
>
> **PantryIQ:** I don't see it — there are 0 salmon rows in the
> transactions between 18 and 24 Aug. It's possible it's under a different
...
intelligent (as a modifier), smart (as a modifier), optimise (as a verb
...
in an error), emoji in product copy, second-person imperatives that read
as commands, rhetorical questions.

**Numbers:** always concrete. "$840" not "significant savings." "3 days"
...
Name the thing and the consequence. Never rely on colour alone.
...
| Off-brand | On-brand |
|---|---|
| Our AI-powered engine analyses your data to unlock actionable insights. | Upload a spreadsheet. I'll tell you what's costing you money and show you the arithmetic. |
| Great news! Your margins are trending up! 🎉 | Margin is up 1.8 points on last week, mostly from produce. |
| Warning: High spoilage risk detected. | $840 of salmon is likely to turn before it sells. |
| We're confident this recommendation will improve your bottom line. | This is worth about $840 if it plays out the way the last four weeks suggest. It might not. |
| Invalid file format. | I can read CSV files. That one's an .xlsx — export it as CSV and I'll take it. |
| Optimise your inventory with intelligent forecasting. | Know what to order less of, before you order it. |
