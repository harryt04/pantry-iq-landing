...
const canonicalIndexes = [
  'connector_connections_location_provider_idx',
  'connector_connections_status_idx',
  'connector_oauth_states_expiry_idx',
  'connector_oauth_states_state_hash_idx',
  'connector_webhook_deliveries_event_idx',
  'connector_webhook_deliveries_received_idx',
  'external_signal_fetches_location_requested_at_idx',
  'external_signals_location_date_idx',
  'external_signals_location_kind_date_idx',
  'external_signals_location_source_external_feature_idx',
  'inventory_items_location_canonical_name_idx',
  'inventory_snapshots_location_counted_at_idx',
  'labor_shifts_location_role_idx',
  'labor_shifts_location_shift_start_idx',
  'labor_shifts_location_source_external_id_idx',
  ...
  'reconciliation_conflicts_location_status_idx',
...
const canonicalColumns = [
  ...
  ['connector_connections', 'id', false, 'uuid'],
  ['connector_connections', 'location_id', false, 'uuid'],
  ['connector_connections', 'provider', false, 'text'],
  ['connector_connections', 'external_account_id', true, 'text'],
  ['connector_connections', 'status', false, 'text'],
  ['connector_connections', 'encrypted_credentials', false, 'text'],
  [
    'connector_connections',
  ...
  ['connector_connections', 'sync_cursor', true, 'text'],
  ['connector_connections', 'backfill_cursor', true, 'text'],
  ['connector_connections', 'last_synced_at', true, 'timestamp with time zone'],
  ['connector_connections', 'last_error', true, 'text'],
  ['connector_connections', 'connected_at', true, 'timestamp with time zone'],
  ['connector_connections', 'created_at', false, 'timestamp with time zone'],
  ['connector_connections', 'updated_at', false, 'timestamp with time zone'],
  ['connector_oauth_states', 'id', false, 'uuid'],
  ['connector_oauth_states', 'location_id', false, 'uuid'],
  ['connector_oauth_states', 'provider', false, 'text'],
  ['connector_oauth_states', 'state_hash', false, 'text'],
  ['connector_oauth_states', 'redirect_uri', false, 'text'],
  ['connector_oauth_states', 'return_to', true, 'text'],
  ['connector_oauth_states', 'expires_at', false, 'timestamp with time zone'],
  ['connector_oauth_states', 'consumed_at', true, 'timestamp with time zone'],
  ['connector_oauth_states', 'created_at', false, 'timestamp with time zone'],
  ['connector_webhook_deliveries', 'id', false, 'uuid'],
  ['connector_webhook_deliveries', 'connection_id', false, 'uuid'],
  ['connector_webhook_deliveries', 'provider_event_id', false, 'text'],
  ['connector_webhook_deliveries', 'payload_hash', false, 'text'],
  [
    'connector_webhook_deliveries',
    'received_at',
    false,
  ...
  ['labor_shifts', 'id', false, 'uuid'],
  ['labor_shifts', 'location_id', false, 'uuid'],
  ['labor_shifts', 'shift_start', false, 'timestamp with time zone'],
  ['labor_shifts', 'shift_end', true, 'timestamp with time zone'],
  ['labor_shifts', 'external_id', false, 'text'],
  ['labor_shifts', 'source', false, 'text'],
  ['labor_shifts', 'employee_reference', true, 'text'],
  ['labor_shifts', 'role', false, 'text'],
  ['labor_shifts', 'scheduled_hours', true, 'numeric'],
  ['labor_shifts', 'actual_hours', true, 'numeric'],
  ['labor_shifts', 'labor_cost', true, 'numeric'],
  ['labor_shifts', 'created_at', false, 'timestamp with time zone'],
  ['external_signal_fetches', 'id', false, 'uuid'],
  ['external_signal_fetches', 'location_id', false, 'uuid'],
  ['external_signal_fetches', 'source', false, 'text'],
  [
    'external_signal_fetches',
    'requested_at',
    false,
  ...
  ['external_signal_fetches', 'completed_at', true, 'timestamp with time zone'],
  ['external_signal_fetches', 'status', false, 'text'],
  ['external_signal_fetches', 'row_count', false, 'integer'],
  ['external_signal_fetches', 'cost_micros', false, 'numeric'],
  ['external_signal_fetches', 'currency', false, 'text'],
  ['external_signal_fetches', 'error', true, 'text'],
  ['external_signal_fetches', 'created_at', false, 'timestamp with time zone'],
  ['external_signals', 'id', false, 'uuid'],
  ['external_signals', 'location_id', false, 'uuid'],
  ['external_signals', 'fetch_id', true, 'uuid'],
  ['external_signals', 'kind', false, 'text'],
  ['external_signals', 'business_date', false, 'text'],
  ['external_signals', 'valid_from', false, 'timestamp with time zone'],
  ['external_signals', 'valid_to', false, 'timestamp with time zone'],
  ['external_signals', 'status', false, 'text'],
  ['external_signals', 'source', false, 'text'],
  ['external_signals', 'external_id', false, 'text'],
  ['external_signals', 'feature', false, 'text'],
  ['external_signals', 'condition', false, 'text'],
  ['external_signals', 'value', false, 'numeric'],
  ['external_signals', 'raw_data', false, 'jsonb'],
  ['external_signals', 'source_url', true, 'text'],
  ['external_signals', 'retrieved_at', false, 'timestamp with time zone'],
  ['external_signals', 'created_at', false, 'timestamp with time zone'],
  ...
  ['reconciliation_conflicts', 'id', false, 'uuid'],
  ['reconciliation_conflicts', 'location_id', false, 'uuid'],
  ['reconciliation_conflicts', 'record_kind', false, 'text'],
  ['reconciliation_conflicts', 'conflict_type', false, 'text'],
  ['reconciliation_conflicts', 'identity_key', false, 'text'],
  ['reconciliation_conflicts', 'external_id', true, 'text'],
  [
    'reconciliation_conflicts',
    'period_start',
    false,
  ...
  ['reconciliation_conflicts', 'period_end', false, 'timestamp with time zone'],
  ['reconciliation_conflicts', 'sources', false, 'jsonb'],
  ['reconciliation_conflicts', 'status', false, 'text'],
  ['reconciliation_conflicts', 'authority_source', true, 'text'],
  ['reconciliation_conflicts', 'details', false, 'jsonb'],
  ['reconciliation_conflicts', 'created_at', false, 'timestamp with time zone'],
  ['reconciliation_conflicts', 'updated_at', false, 'timestamp with time zone'],
    ...
    it(
      ...
      `
        ...
        from (values
          ...
          ('public.external_signal_fetches'),
